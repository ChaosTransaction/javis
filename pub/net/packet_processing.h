...
#ifndef NET_PACKET_PROCESSING_H_
#define SNET_PACKET_PROCESSING_H_
...
class PacketProsess {
 public:
  ...
  static bool StrPacket(const int16 t_operate_code, const int8 t_is_zip_encrypt,
                        const int8 t_type, int64 t_session_id,
                        const int32 t_reserved, const std::string& body_stream,
                        void **packet_stream, int32 *packet_stream_length);
